...
LOCAL_MODULE_STEM := hwcomposer.baytrail_64
LOCAL_MODULE_SUFFIX := $(TARGET_SHLIB_SUFFIX)
LOCAL_MODULE_OWNER := intel
LOCAL_SRC_FILES := $(TARGET_ARCH)/hwcomposer.baytrail_64$(LOCAL_MODULE_SUFFIX)
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_RELATIVE_PATH := hw
LOCAL_MODULE_STEM := gralloc.baytrail_64
LOCAL_MODULE_SUFFIX := $(TARGET_SHLIB_SUFFIX)
LOCAL_MODULE_OWNER := intel
LOCAL_SRC_FILES := $(TARGET_ARCH)/gralloc.baytrail_64$(TARGET_SHLIB_SUFFIX)
include $(BUILD_PREBUILT)
