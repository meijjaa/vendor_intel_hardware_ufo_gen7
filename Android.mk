...
LOCAL_MODULE_PATH_32_GFX_LIB := $(TARGET_OUT)/vendor/gfx/$(BASE_GFX_DIR)/lib
LOCAL_MODULE_PATH_64_GFX_LIB := $(TARGET_OUT)/vendor/gfx/$(BASE_GFX_DIR)/lib64
LOCAL_MODULE_PATH_GFX_BIN := $(TARGET_OUT)/vendor/gfx/$(BASE_GFX_DIR)/bin
